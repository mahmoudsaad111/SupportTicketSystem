...
{
    [DbContext(typeof(SupportTicketSystemDbContext))]
    partial class SupportTicketSystemDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SupportTicketSystem.Domain.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("SupportTicketSystem.Domain.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SupportTicketSystem.Domain.Tickets.TicketComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SupportTicketSystem.Domain.Tickets.TicketStatusChange", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTicketStatusChanges", (string)null);
                });
            ...
            modelBuilder.Entity("SupportTicketSystem.Domain.Tickets.Ticket", b =>
                {
                    b.OwnsOne("SupportTicketSystem.Domain.Tickets.TicketPriority", "Priority", b1 =>
                        {
                            ...
                            b1.Property<long>("SlaWindow")
                                .HasColumnType("bigint")
                                .HasColumnName("PrioritySlaWindow");

                            b1.HasKey("TicketId");

                            b1.ToTable("AppTickets");
            ...
            modelBuilder.Entity("SupportTicketSystem.Domain.Tickets.TicketComment", b =>
                {
                    b.HasOne("SupportTicketSystem.Domain.Tickets.Ticket", null)
                        .WithMany("Comments")
                        .HasForeignKey("TicketId")
