...
[DependsOn(
    typeof(SupportTicketSystemApplicationTestModule),
    typeof(SupportTicketSystemEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class SupportTicketSystemEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new SupportTicketSystemDbContext(new DbContextOptionsBuilder<SupportTicketSystemDbContext>().UseSqlite(_database.ConnectionString).Options));
